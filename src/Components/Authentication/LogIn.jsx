                    ...
                    <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
                        <div className="card-body">
                            ...
                            <form onSubmit={handleLogIn} className="fieldset">
                                ...
                                <h1 className='text-sm'>Already have an account? <Link to={"/register"}><span className='text-purple-700 font-bold underline'>Register</span></Link> </h1>

                                <button className="btn btn-neutral mt-4  border-none text-white ">{loading ? <span className="loading loading-spinner loading-md"></span> : "LogIn"}</button>
                            </form>

...
const Register = () => {
    ...
    const handleRegister = (e) => {
        ...
        console.log('function running', email, password)
                    ...
                    <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
                        <div className="card-body">
                            ...
                            <form onSubmit={handleRegister} className="fieldset">
                                ...
                                <label className="label text-black font-semibold">PhotoURL</label>
                                <input type="url" className="input w-full" placeholder="Url of Your Photo" name='photoURL' />
                                ...
                                <h1 className='text-sm'>Already have an account? <Link to={"/login"}><span className='text-purple-700 font-bold underline'>LogIn</span></Link> </h1>
                                <button className="btn btn-neutral mt-4  border-none text-white ">{loading ? <span className="loading loading-spinner loading-md"></span> : "Register"}</button>
                            </form>
